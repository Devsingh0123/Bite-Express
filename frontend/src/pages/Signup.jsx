    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-500 to-red-500">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        <form  onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Mobile */}
          <div>
            <label htmlFor="tel" className="text-sm text-gray-600">Mobile Number</label>
            <input
            id="tel"
              type="tel"
              name="mobile"
          ...
          <div>
            ...
            id="role"
              ...
              value={formData.role}
              onChange={handleChange}
              className="w-full mt-1 px-4 py-2 border rounded-lg bg-white focus:ring-2 focus:ring-orange-400 outline-none cursor-pointer"
            >
              <option className="cursor-pointer" value="user">User</option>
              <option className="cursor-pointer" value="admin">Admin</option>
              <option className="cursor-pointer" value="delivery">Delivery Boy</option>
            </select>
          </div>
